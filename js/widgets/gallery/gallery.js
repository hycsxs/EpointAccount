...
(function() {
    ...
    Gallery.prototype = {
        ...
        _renderGenHtml: function() {
            ...
            // TODO(wsze): html的具体生成还有优化余地，比如拼接方式的改变，比如one和array函数的复用
            ...
            if (options.isLoop) {
                ...
                if (Array.isArray(data[(tmpJ)])) {
                    // 数组对象
                    html += generateArrayItemsImg(data[(tmpJ)], true);
                } else if (data[tmpJ]) {
                    // 普通的对象
                    html += generateOneItemImg(data[(tmpJ)], true);
                }
            }
