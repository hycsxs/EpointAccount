...
(function (global, factory) {
    ...
    var Scroll = (function () {
        ...
        _createClass$1(Scroll, [{
            ...
            value: function triggerDownLoading(type) {
                var options = this.options;
                ...
                if (!this.hooks[HOOK_BEFORE_DOWN_LOADING] || this.hooks[HOOK_BEFORE_DOWN_LOADING](this.downHight, options.down.offset)) {
                    ...
                    // type = 'noAnim' 没有下拉刷新动画 wsz 2018-07-16 14:15:54
                    if (type && type == 'noAnim') {
                        this.translateContentWrap(0);
                        this.endDownLoading();
    ...
    var Core = (function () {
        ...
        _createClass(Core, [{
            ...
            value: function triggerDownLoading(type) {
                ...
                this.scroller.triggerDownLoading(type);
            }
    ...
    var MiniRefreshTheme = (function (_Core) {
        ...
        _createClass(MiniRefreshTheme, [{
            ...
            value: function _downLoaingEndHook(isSuccess) {
                ...
                // 解决列表透明时一直显示加载中提示的问题
                this.downWrap.style.visibility = 'hidden';
