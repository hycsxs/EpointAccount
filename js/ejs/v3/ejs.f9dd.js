                    ...
                    success: function success(result) {
                        ...
                        dd.ready(function () {
                            ...
                            document.addEventListener('resume', function () {
                                ...
                                // else {
                                //     // 打开时没有设置成功回调或者没有关闭页面回调参数
                                //     // 清除打开页面的id标识存储的回调参数
                                //     localStorage.removeItem(funcName);
                                //     // 剔除打开页面id的数组集合最后一个id
                                //     funcName.pop();
                                //     // 重新存储
                                //     localStorage.setItem('f9PageGuid', JSON.stringify(funcName));
                                // }
                            });
                            resolve();
                        });
...
var invokePluginApi = function (opt, cb) {
    if (opt.path === 'workplatform.provider.openNewPage' && opt.dataMap.method === 'goSelectPerson') {
        ...
        dd.biz.contact.complexPicker({
            title: '选择页面', // 标题
            corpId: opt.dataMap.corpId || 'ding48f4e4cc630d5ccd35c2f4657eb6378f', // 企业的corpId
            ...
            onSuccess: function onSuccess(result) {
                ...
                /* var result = {
                    ...
                    "users": [{
                        "name": "王凯",
                        "avatar": "",
                        "emplId": "396b8d91-a19c-4c65-9308-227a979d983d"
                    }, {
                        "name": "吴松泽",
                        "avatar": "",
                        "emplId": "440c5ddb-af66-45cf-aa17-145382e6780b"
                    }, {
                        "name": "朱德振",
                        "avatar": "",
                        "emplId": "034e38c7-8421-47be-a72b-b4a2050144b3"
                    }],
                    "departments": []
                }; */
            },
