                    ...
                    case 'showWaiting':
                        innerDOM = h(
                            vant.Popup,
                            {
                                ...
                                style: { width: '80%', height: '100px', backgroundColor: '#fff' }
                            },
                            [h(
                                vant.Loading,
                                {
...
deviceMixin$1(hybridJs);
eventMixin(hybridJs);
storageMixin$1(hybridJs);
pageMixin$2(hybridJs);
navigatorMixin(hybridJs);
utilMixin(hybridJs);
streamMixin(hybridJs);
contactMixin$1(hybridJs);
audioMixin(hybridJs);
ioMixin(hybridJs);
