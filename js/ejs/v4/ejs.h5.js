...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('vue'), require('vant'), require('@babel/runtime/helpers/typeof')) :
  typeof define === 'function' && define.amd ? define(['vue', 'vant', '@babel/runtime/helpers/typeof'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Vue, global.vant, global._typeof2));
})(this, (function (Vue, vant, _typeof2) { 'use strict';

  function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

  var Vue__default = /*#__PURE__*/_interopDefaultLegacy(Vue);
  var _typeof2__default = /*#__PURE__*/_interopDefaultLegacy(_typeof2);
  ...
  function uiMixin(hybrid) {
    ...
    hybridJs.extendModule('ui', [{
      ...
      runCode: function runCode() {
        ...
        var args = rest;
        var options = args[0];
        options.data = options.data.map(function (ele) {
          var res = ele;
          res.text = $t$1(res.text);

          if (res.children && res.children.length) {
            res.children = res.children.map(function (item) {
              var res2 = item;
              res2.text = $t$1(res2.text);

              if (res2.children && res2.children.length) {
                res2.children = res2.children.map(function (element) {
                  var res3 = element;
                  res3.text = $t$1(element.text);
                  return res3;
                });
              }
  ...
  function pageMixin(hybrid) {
    ...
    hybridJs.extendModule('page', [{
      ...
      runCode: function runCode() {
        ...
        var options = args[0]; // 政务微信环境下，统一去掉.html后缀

        if (hybridJs.os.wxWorkLocal) {
          options.pageUrl = options.pageUrl.replace(/.html/, '');
        }
        ...
        if (window.vm && vm.$router && options.useRouter) {
          ...
          // 将额外数据拼接到url中
          options.pageUrl = innerUtil.getFullUrlByParams(options.pageUrl, options.data); // 普通
    ...
    hybridJs.extendModule('storage', [{
      ...
      runCode: function runCode(params, resolve, reject) {
        ...
        try {
          ...
          var err = {
            code: 0,
            msg: "localStorage\u83B7\u53D6\u503C\u51FA\u9519:".concat(JSON.stringify(keys)),
            result: msg
          };
          error && error(err);
          reject && reject(err);
      ...
      runCode: function runCode(params, resolve, reject) {
        ...
        try {
          ...
          var err = {
            code: 0,
            msg: "localStorage\u79FB\u9664\u503C\u51FA\u9519:".concat(JSON.stringify(keys)),
            result: msg
          };
          error && error(err);
          reject && reject(err);
      ...
      runCode: function runCode(params, resolve, reject) {
        var options = params;
        hybridJs.storage.getItem.apply(this, [options]);
      }
    }, {
      ...
      runCode: function runCode(params, resolve, reject) {
        var options = params;
        hybridJs.storage.setItem.apply(this, [options]);
      }
    }]);
  }
  ...
  function deviceMixin(hybrid) {
    ...
    hybridJs.extendModule('device', [{
      ...
      runCode: function runCode() {
        ...
        window.location.href = "sms:".concat(phoneNum, "?body=").concat(message);
      }
    }, {
      namespace: 'sendMail',
      os: ['h5'],
      ...
      runCode: function runCode() {
        ...
        var cc = args[0].cc;
        window.location.href = "mailto:".concat(mail, "?subject=").concat(subject, "&cc=").concat(cc);
      }
    }]);
  }
   ...
   */
  (function (global, factory) {
    (typeof exports === "undefined" ? "undefined" : _typeof2__default["default"](exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global = global || self, global.Sortable = factory());
  })(undefined, function () {

    function _typeof(obj) {
      if (typeof Symbol === 'function' && _typeof2__default["default"](Symbol.iterator) === 'symbol') {
        _typeof = function _typeof(obj) {
          return _typeof2__default["default"](obj);
        };
      } else {
        _typeof = function _typeof(obj) {
          return obj && typeof Symbol === 'function' && obj.constructor === Symbol && obj !== Symbol.prototype ? 'symbol' : _typeof2__default["default"](obj);
        };
      }
