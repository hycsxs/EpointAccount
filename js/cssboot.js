...
(function (exports) {
   ...
   */
  exports.TIME_STAMP =
    "_=" + (exports.isDebug ? "201202222259" : "208222522299") + Math.random();
...
(function (exports) {
  ...
  var SrcBoot = {
    ...
    getProjectBasePath: function (reg) {
      ...
      // 兼容在网站根路径时的路径问题
      basePath =
        obj.protocol + "//" + obj.host + (contextPath ? contextPath : "/");
    ...
    getFullPath: function (path) {
      // 全路径
      if (/^(http|https|ftp|epth5|EPTH5|file|\/\/)/g.test(path)) {
        return path;
      }
      // 是否是相对路径
...
var paths = [
    ...
    bizRootPath + 'js/widgets/vant/index.css'
];
